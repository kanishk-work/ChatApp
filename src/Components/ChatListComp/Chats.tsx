...
const Chats: FC<{}>= () => {
  return (
      ...
      {
        chats.map((chat)=>
          <Link to="/" className='flex items-center justify-center text-slate-100 w-full mb-2 p-1.5 hover:bg-[var(--accent-color)] hover:shadow-[0px_0px_20px_0px_#00000024] rounded-lg'>
