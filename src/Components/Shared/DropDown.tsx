...
const DropDown = ({ optionsList, btnClassName, itemClassName }: props) => {
  return (
    <Menu as="div" className={`relative inline-block text-left`}>
      <div>
        <MenuButton
          className={`${btnClassName} flex items-center text-2xl py-1 text-[var(--text-secondary)] rounded-full data-[hover]:bg-[var(--accent-color)] data-[open]:bg-[var(--accent-color)] data-[focus]:outline-1 data-[focus]:outline-white`}
        >
