...
const LoginPage: React.FC<propsType> = ({ loginFn }) => {
    ...
    const userCredentials = {
        ...
        lastName: lastName,
        role: role,
        profile_pic_url: 'https://img.freepik.com/premium-photo/stylish-man-flat-vector-profile-picture-ai-generated_606187-309.jpg'
    };
    ...
    return (
        <div className='h-screen w-screen flex items-center justify-center dynamic-background-color'>
            <form className='flex flex-col gap-5 bg-green-600 rounded-xl p-10'>
                ...
                <button type="button" onClick={handleSubmit} className='bg-green-200 rounded-lg px-4 py-2'>Submit</button>
            </form>
        </div>
